...
window.UI = (function () {
  ...
  return { icon, esc, initials, kip, kpi, card, badge, idtag, rowitem, rowlist, table, steps, empty, avatar, sparkline, bars, lines2, donut, heatcal, legend, lockMsg, lockTag, lockBtn, lockChoice };
})();
