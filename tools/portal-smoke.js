...
for (const f of ["js/i18n.js", "js/ui.js", "js/db.js", "js/auth.js", "js/data.js",
...
ok(APP_HTML.includes("LDAP / RADIUS") && APP_HTML.includes("Professional · ≤250"), "console: D1 tier badges missing");
...
// 10 · flag off → persona menu only, no wall anywhere, no sign-in section
clickAct("portal-toggle");
ok(!AUTH.portalOn(), "flag: toggle off failed");
location.hash = "#/launcher";
ok(!APP_HTML.includes("landing-auth"), "flag off: landing sign-in section should disappear");
...
clickAct("portal-toggle"); // leave the demo with the door on
ok(AUTH.portalOn(), "flag: toggle back on failed");
